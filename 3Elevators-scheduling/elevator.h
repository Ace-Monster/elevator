...
namespace myelevator
{
	...
	class Run {
	public:
		static int distribution_run_main(std::string, std::string output1 = "output1.txt", std::string output2 = "output2.txt", std::string output3 = "output3.txt");
		static int global_run_main(std::string, std::string output1 = "output1.txt", std::string output2 = "output2.txt", std::string output3 = "output3.txt");
	};
}